        ...
        <section id="contact" className="py-20 px-6 bg-slate-900/50">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <a
                href="mailto:brickersan@gmail.com?"
                className="px-8 py-4 bg-gradient-to-r from-cyan-500 to-emerald-500 rounded-lg font-semibold hover:shadow-lg hover:shadow-cyan-500/50 transition-all flex items-center gap-2">
                <Mail size={20} />
                Send Email
              </a>
              <a href={`${import.meta.env.BASE_URL}HunterBrickers-resume.pdf`} download className="px-8 py-4 border border-cyan-500/50 rounded-lg font-semibold hover:bg-cyan-500/10 transition-all">
                Download Resume
              </a>
            </div>
          </div>
